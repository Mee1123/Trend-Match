...
<body>
	...
	<div class="container">
		...
		<form action="/SE18G2/checkAccountRegistration" method="post"
			...
			<!-- headerを入れます -->
			<!-- <input type="file" name="picturepath" size="30"/><br>プロフィール画像<br> -->
			<p>
			...
			<p>
				...
				<input class="form-control" type="hidden" name="freespace"
					value=<%=request.getAttribute("freeSpace")%>> <br>
			</p>
			<p>
				価値観<br>
				<c:out value="${value1 }"></c:out>
				<br>
				<c:out value="${value2 }"></c:out>
				<br>
				<c:out value="${value3 }"></c:out>
				<br> <input class="form-control" type="hidden" name="value1"
					value=<%=request.getAttribute("value1")%>><br> <input
					class="form-control" type="hidden" name="value2"
					value=<%=request.getAttribute("value2")%>><br> <input
