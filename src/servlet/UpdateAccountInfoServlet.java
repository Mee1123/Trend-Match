...
public class UpdateAccountInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (SessionHelper.sessionCheck(request, response)) {
			...
			String graduate1 = request.getParameter("graduate") + "0331";
			int graduate2 = Integer.parseInt(graduate1);
			...
			UpdateAccountInfoForm form = new UpdateAccountInfoForm(nickName, picturePath, graduate2, department,
					occupationId, sexId,
					contact, freeSpace,
			...
			if (form.getError().isEmpty()) {
				...
				if (form.getError().isEmpty()) {
					...
					RequestDispatcher dispatcher = request
							.getRequestDispatcher("/WEB-INF/jsp/account/updateFinished.jsp");
					dispatcher.forward(request, response);
				} else {
